    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-solid">
                <form role="form" method="post"  enctype="multipart/form-data" action="{{ route('backend.article.update', ['id' => $article->id]) }}" id="article-form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class='col-md-6'>
                                    <input type='text' value = "{{ $article->article }}" class='form-control' name="keyword" id='keyword' placeholder='请输入关键字，以英文逗号分割，利于搜索引擎收录'>
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="user_pic">Image</label>
                            <div class="row">
                                <div class='col-md-3'>
                                    <input type="file" name="article_pic" id="article_pic" accept="image/png,image/gif,image/jpeg" >
                                </div>
                                <div class='col-md-6'>
                                    <img src="{{ asset('uploads/article') }}/{{ $article->article_pic }}" class="img-circle" style="width:80px;height:auto;">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
